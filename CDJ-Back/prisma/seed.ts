...
async function main() {
  ...
  // === Feature cards ===
  const featureCards = [
    { id: 'edutips',        title: 'Edutips',             description: 'Cápsulas breves para aprender, conversar y actuar mejor.',          icon: 'play_arrow', iconBgClass: 'bg-blue-600',   iconShadowClass: 'shadow-blue-200',   imageUrl: '/assets/img/feature-edutips.svg',        destination: 'edutips',        audience: 'edutips',  illoScene: 'spark',   badge: 'Biblioteca',    sortOrder: 1,  sections: ['inicio'] },
    { id: 'casi',           title: 'El día que casi',     description: 'Serie animada con historias que evitaron un riesgo digital.',       icon: 'star',       iconBgClass: 'bg-amber-500',  iconShadowClass: 'shadow-amber-100',  imageUrl: '/assets/img/feature-casi.svg',           destination: 'series_casi',   audience: 'casi',     illoScene: 'play',    badge: 'Serie animada', sortOrder: 2,  sections: ['inicio'] },
