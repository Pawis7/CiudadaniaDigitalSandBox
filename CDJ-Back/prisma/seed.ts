...
async function main() {
  ...
  // === Feature cards ===
  const featureCards = [
    { id: 'edutips', title: 'Edutips',         description: 'Cápsulas breves para aprender, conversar y actuar mejor.',          icon: 'play_arrow', iconBgClass: 'bg-blue-600',  iconShadowClass: 'shadow-blue-200',  imageUrl: '/assets/img/feature-edutips.svg', href: '/edutips',                audience: 'edutips', illoScene: 'spark',  badge: 'Biblioteca',    sortOrder: 1 },
    { id: 'casi',    title: 'El día que casi', description: 'Serie animada con historias que evitaron un riesgo digital.',       icon: 'star',       iconBgClass: 'bg-amber-500', iconShadowClass: 'shadow-amber-100', imageUrl: '/assets/img/feature-casi.svg',    href: '/series/el-dia-que-casi', audience: 'casi',    illoScene: 'play',   badge: 'Serie animada', sortOrder: 2 },
    { id: 'ayuda',   title: 'Ayuda Digital',   description: 'Si recibiste un fraude, acoso o algo no está bien, no estás solo.', icon: 'shield',     iconBgClass: 'bg-rose-500',  iconShadowClass: 'shadow-rose-100',  imageUrl: '/assets/img/feature-ayuda.svg',  href: '/ayuda',                  audience: 'help',    illoScene: 'shield', badge: 'Orientación',   sortOrder: 3 },
  ] as const;
