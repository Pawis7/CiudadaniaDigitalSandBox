...
async function main() {
  ...
  // === Feature cards ===
  const featureCards = [
    { id: 'edutips',        title: 'Edutips',             description: 'Cápsulas breves para aprender, conversar y actuar mejor.',          icon: 'play_arrow', iconBgClass: 'bg-blue-600',   iconShadowClass: 'shadow-blue-200',   imageUrl: '/Portadas/Edutips_Portada.png',          destination: 'edutips',        audience: 'edutips',  illoScene: 'spark',   badge: 'Biblioteca',    sortOrder: 1,  sections: ['inicio', 'series'] },
