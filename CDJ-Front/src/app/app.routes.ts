...
export const routes: Routes = [
 ...
 {path:'pantallas-seguras',loadComponent:()=>import('./pantallas-seguras/pantallas-seguras').then(m=>m.PantallasSegurasComponent),title:'Pantallas Seguras · Ciudadanía Digital'},
 {path:'ayuda',loadComponent:()=>import('./ayuda/ayuda').then(m=>m.AyudaComponent),title:'Ayuda Digital · Ciudadanía Digital'},
 {path:'p/:slug',loadComponent:()=>import('./audiencia/audiencia').then(m=>m.AudienciaComponent),title:'Ciudadanía Digital'},
 {path:'**',redirectTo:''}
];
