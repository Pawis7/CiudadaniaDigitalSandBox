...
import { ADULT_PRESENCE_DATA, AdultPresenceQuestion, AdultPresenceOption, AdultPresenceResult } from '../../core/data/adult-presence.data';

@Component({
  selector: 'app-adult-presence',
  standalone: true,
  imports: [CommonModule, FormsModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './adult-presence.html',
  styleUrl: './adult-presence.css',
})
export class AdultPresenceComponent {
  readonly data = ADULT_PRESENCE_DATA;
  ...
  // Computations
  readonly currentQuestion = computed<AdultPresenceQuestion>(() => {
  ...
  readonly result = computed<AdultPresenceResult>(() => {
