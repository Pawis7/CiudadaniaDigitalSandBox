...
export const RECONOZCO_EMOCIONES_DATA: EmotionsGameData = {
  ...
  subtema_foco: "Reconocer cómo una interacción en pantalla puede generar alegría, susto, enojo/frustración, tristeza, cansancio, duda o calma; y practicar una respuesta segura con mediación adulta.",
  ...
  competencia_especifica: "Reconoce emociones básicas que pueden surgir durante una interacción digital sencilla y practica respuestas seguras: pausar, respirar, esperar turno, apagar o pedir ayuda adulta.",
  ...
  resultado_observable: "La niña o el niño identifica emociones en el personaje, selecciona una carita o acción segura y repite al cierre la rutina: pauso, respiro y pido ayuda.",
  producto_a_desarrollar: "Juego interactivo lineal de 12 escenas con audio, caritas emocionales, feedback positivo, pausas pedagógicas y cierre de descanso de pantallas.",
  enfoque_didactico_recomendado: "Juego guiado, visual, breve, con mediación adulta total. Para preescolar se recomienda jugarlo en dos bloques de 6 escenas o seleccionar escenas según el objetivo de la sesión.",
  elemento_narrativo_metafora: "Bit descubre que su luz cambia según lo que siente al usar una pantalla; Data lo acompaña a nombrar la emoción, respirar, poner límites sencillos y pedir ayuda.",
  ...
  formato_tipo_concreto: "Interacción lineal de 12 escenas tipo H5P o HTML, con audio, botones grandes, feedback sin castigo, pausa intermedia y avance manual.",
  contexto_de_uso: "Aula de preescolar, rincón digital o sesión guiada por docente",
  nivel_sugerido: "Preescolar",
  responsable_sugerido: "Diseño instruccional, diseño visual, programación, revisión pedagógica y QA institucional",
  estado_sugerido: "Listo para producción con validación de personajes oficiales",
  duracion_estimada: "10 a 15 minutos si se juega completo; recomendado en dos bloques de 5 a 8 minutos.",
  ...
  escenas: [
    {
      ...
      refuerzo: "Las pantallas pueden mostrarnos cosas bonitas. También podemos compartir con respeto.",
      voz_situacion: "Mira a Bit. Su abuelito le envió un video de un perrito saltando. ¡Qué divertido!",
    ...
    },
    {
      ...
      voz_situacion: "Data nota que Bit ha sentido muchas cosas. Le propone hacer una pausa pequeña.",
    ...
    },
    {
      ...
      voz_situacion: "Un amigo quiere usar la tablet de Bit y se acerca muy rápido. Bit se molesta.",
    ...
    },
    {
      ...
      char: "🤖🏆",
      reto_visible: "Bit ganó un juego y se emocionó mucho. ¿Cómo puede celebrar cuidando a los demás?",
      opciones_visibles: [
        "🎉 Celebrar sin gritar",
        "📢 Gritar muy fuerte",
    ...
    },
    {
      ...
      situacion: "Data avisa que el tiempo de pantalla terminó. Bit quiere seguir, pero también quiere sentirse bien.",
      ...
      voz_situacion: "Data avisa que el tiempo de pantalla terminó. Bit quiere seguir, pero también quiere sentirse bien.",
