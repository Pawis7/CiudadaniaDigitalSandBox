...
export const AUDIENCE_PAGES: AudiencePage[] = [
  {
    ...
    subLevels: [
      ...
      { id: 'primaria-baja',  title: 'Primaria baja', subtitle: '6 a 8 años',  imageUrl: 'https://images.unsplash.com/photo-1522661067900-ab829854a57f?auto=format&fit=crop&q=80&w=900', imageId: 'sub-kids-pb',  bgClass: 'from-emerald-400 to-cyan-500', icon: 'auto_stories', resourceCount: 18 },
    ...
    topics: [
      { icon: 'shield_person',  title: 'Cuidado en línea',     description: 'Saber qué compartir y qué no.',    bgClass: 'bg-teal-500' },
      { icon: 'sentiment_calm', title: 'Buen trato',            description: 'Tratar bonito y poner límites.',  bgClass: 'bg-emerald-500' },
  ...
  },
  {
    ...
    accentClass: 'from-emerald-500 via-teal-500 to-blue-500',
    pillBgClass: 'bg-emerald-500',
    iconBgClass: 'bg-emerald-500',
    icon: 'school',
    ageRange: 'Preescolar a preparatoria',
    subLevels: [
      { id: 'doc-pre',  title: 'Preescolar',     subtitle: '3 a 5 años',   imageUrl: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&q=80&w=900', imageId: 'sub-doc-pre', bgClass: 'from-emerald-500 to-teal-500', icon: 'child_friendly', resourceCount: 8 },
      { id: 'doc-pb',   title: 'Primaria baja',  subtitle: '6 a 8 años',   imageUrl: 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?auto=format&fit=crop&q=80&w=900', imageId: 'sub-doc-pb',  bgClass: 'from-teal-500 to-cyan-500',    icon: 'menu_book',      resourceCount: 14 },
    ...
    topics: [
      { icon: 'menu_book',  title: 'Secuencias didácticas', description: 'Planeaciones por nivel.',           bgClass: 'bg-emerald-500' },
      { icon: 'task_alt',   title: 'Proyectos integradores', description: 'Aprendizaje basado en retos.',     bgClass: 'bg-teal-500' },
...
export const RESOURCES = [
  ...
  { id: 'r4', title: 'Guías y checklist', icon: 'fact_check', bgClass: 'bg-emerald-500', description: 'Pasos para aplicar lo aprendido.' },
  { id: 'r5', title: 'Secuencias didácticas', icon: 'route', bgClass: 'bg-teal-500',   description: 'Planeaciones para llevar al aula.' },
...
export const ABOUT_TEAM = [
  { id: 't1', name: 'Equipo pedagógico',   role: 'Diseño curricular',     icon: 'school',   bgClass: 'bg-emerald-500' },
