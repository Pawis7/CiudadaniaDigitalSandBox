...
export const FEATURE_CARDS: FeatureCard[] = [
  ...
  },
  {
    ...
    description: 'Guías y diálogos para acompañar a hijas e hijos en su vida en línea.',
    icon:           'groups',
    iconBgClass:    'bg-gradient-to-br from-orange-400 via-orange-500 to-red-500',
    iconShadowClass: 'shadow-orange-100',
    imageUrl:    '/assets/img/series-cover-familias.svg',
    destination: 'series',
    href:        '/series/familias-conectadas',
    audience:    'families',
    illoScene:   'connect',
    badge:       'Serie familiar',
    sections:    ['series'],
  },
  {
    id:          'ayuda',
