...
export const CARD_DESTINATIONS: CardDestinationOption[] = [
  ...
  { key: 'series_familias', label: 'Series para familias',     href: '/series',                       icon: 'family_restroom'},
  { key: 'series_kids',     label: 'Serie: Pequeños Cibernautas', href: '/series/pequenos-cibernautas', icon: 'child_care'  },
  { key: 'series_teens',    label: 'Serie: Edutips',           href: '/edutips',                      icon: 'school'         },
  ...
  { key: 'ninas_y_ninos',   label: 'Perfil: Niñas y Niños',   href: '/p/ninas-y-ninos', icon: 'child_friendly' },
  { key: 'adolescentes',    label: 'Perfil: Adolescentes',     href: '/p/adolescentes',  icon: 'face'           },
  { key: 'familias',        label: 'Perfil: Familias',         href: '/p/familias',      icon: 'groups'         },
  { key: 'docentes',        label: 'Perfil: Docentes',         href: '/p/docentes',      icon: 'person_book'    },
