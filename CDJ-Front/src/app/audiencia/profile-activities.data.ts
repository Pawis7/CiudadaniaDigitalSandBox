...
export interface ProfileActivity { slug:string; kicker:string; title:string; description:string; }
...
export const PROFILE_LEARNING: Partial<Record<AudienceSlug, ProfileLearningBlock>> = {
  kids:{title:'Actividades para aprender y pedir ayuda cuando la necesitas',description:'Algunas puedes hacerlas por tu cuenta y otras indican cuándo conviene participar con una persona adulta de confianza.',activities:[
  ...
  families:{title:'Acompañar cada etapa sin invadir',description:'Experiencias para conversar, acordar límites y fortalecer la autonomía de niñas, niños y adolescentes de acuerdo con su edad.',activities:[
  ...
  teachers:{title:'Situaciones listas para conversar en el aula',description:'Cada recorrido parte de un caso, incorpora un EduTip y cierra con una decisión o acción que puede trabajarse con el grupo.',activities:[
